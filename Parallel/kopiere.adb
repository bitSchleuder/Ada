...
with Karten, Eingabe, Ausgabe, Kommando;

--FROM Karten  IMPORT Karte, KartenBild, Ergebnis, KDO, SUB;
--FROM Eingabe IMPORT LiesDaten, LiesKarte, LiesBinaer;
--FROM Ausgabe IMPORT ZeilenBild, DruckeZeile;
use  Karten, Eingabe, Ausgabe, Kommando;
